...
class Config:
    ...
    #~~~~~~~~~~~~~~~~~~~~~~SMPLX path~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    smplx_path = '/data_nfs/kj/paper_with_code/kypt_transformer' # Path to MANO model files
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#

    # ~~~~~~~~~~~~~~~~~~~~~~InterHand2.6M paths~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    interhand_anno_dir = os.path.join(user_home,'data/InterHand2.6M/annotations')
    interhand_images_path = os.path.join(user_home,'data/InterHand2.6M/images')
    # interhand_anno_dir = '/data_pool/kj/InterHand2.6M/annotations'
    # interhand_images_path = '/data_pool/kj/InterHand2.6M/images'
    ...
    root_net_output_path = os.path.join(user_home,'data/InterHand2.6M/rootnet_output')
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    ...
    import_fidx = [3,7,11,15,19,20,24,28,32,36,40,41]
